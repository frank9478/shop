...
* [GraalVM Native Image Support](https://docs.spring.io/spring-boot/docs/3.0.9/reference/html/native-image.html#native-image)
* [Spring Configuration Processor](https://docs.spring.io/spring-boot/docs/3.0.9/reference/htmlsinge/index.html#appendix.configuration-metadata.annotation-processor)
...
* [Configure AOT settings in Build Plugin](https://docs.spring.io/spring-boot/docs/3.0.9/maven-plugin/reference/htmlsingle/#aot)
